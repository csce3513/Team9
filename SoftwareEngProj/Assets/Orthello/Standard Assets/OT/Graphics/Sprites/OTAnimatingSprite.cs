...
public class OTAnimatingSprite : OTSprite
{
    ...
    public void Pauze()
    {
        ...
        if (!CallBack("onAnimationPauze", new object[] { this }))
            CallBack("OnAnimationPauze", new object[] { this });
    }
    ...
    public void Resume()
    {
        ...
        if (!CallBack("onAnimationResume", new object[] { this }))
            CallBack("OnAnimationResume", new object[] { this });
    }
    ...
    public void Stop()
    {
        ...
        if (!CallBack("onAnimationFinish", new object[] { this }))
            CallBack("OnAnimationFinish", new object[] { this });
    ...
    void UpdateFrame()
    {
        ...
        if (spriteContainer != animationFrame.container || animationFrame.frameIndex != frameIndex)
        {
            ...
            if (!CallBack("onAnimationFrame", new object[] { this }))
                CallBack("OnAnimationFrame", new object[] { this });
