...
public class OTObject : MonoBehaviour
{
    ...
    public virtual void OnInput(Vector2 hitPoint)
    {
        ...
        if (onInput != null)
            onInput(this);
        if (!CallBack("onInput", new object[] { this }))
            CallBack("OnInput", new object[] { this });
    ...
    public virtual void OnMouseMove(Vector2 hitPoint)
    {
        ...
        if (onMouseMoveOT != null)
            onMouseMoveOT(this);
        if (!CallBack("onMouseMoveOT", new object[] { this }))
            CallBack("OnMouseMoveOT", new object[] { this });
    ...
    public virtual void OnMouseEnter()
    {
        ...
        if (onMouseEnterOT != null)
            onMouseEnterOT(this);
        if (!CallBack("onMouseEnterOT", new object[] { this }))
            CallBack("OnMouseEnterOT", new object[] { this });
    ...
    public virtual void OnMouseDrag()
    {
        ...
        if (!isDragging)
        {
            if (onDragStart != null)
                onDragStart(this);
            if (!CallBack("onDragStart", new object[] { this }))
                CallBack("OnDragStart", new object[] { this });
            isDragging = true;
            _hitPoint = OT.view.mouseWorldPosition - position;
        }
    ...
    public virtual void OnMouseUp()
    {
        if (isDragging)
        {
            if (onDragEnd != null)
                onDragEnd(this);
            if (!CallBack("onDragEnd", new object[] { this }))
                CallBack("OnDragEnd", new object[] { this });
    ...
    public virtual void OnMouseExit()
    {
        ...
        if (onMouseExitOT != null)
            onMouseExitOT(this);
        if (!CallBack("onMouseExitOT", new object[] { this }))
            CallBack("OnMouseExitOT", new object[] { this });
    ...
    void OnTriggerEnter(Collider c)
    {
        ...
        if (_collisionObject != null)
        {
            if (_collisionObject.collidable)
            {
                if (onCollision != null)
                    onCollision(this);
                if (!CallBack("onCollision", new object[] { this }))
                    CallBack("OnCollision", new object[] { this });
            }
            if (onEnter != null)
                onEnter(this);
            if (!CallBack("onEnter", new object[] { this }))
                CallBack("OnEnter", new object[] { this });
        }
    }
    ...
    void OnTriggerExit(Collider c)
    {
        ...
        if (onExit != null)
            onExit(this);
        if (!CallBack("onExit", new object[] { this }))
            CallBack("OnExit", new object[] { this });
    }
    ...
    void OnTriggerStay(Collider c)
    {
        ...
        if (onStay != null)
            onStay(this);
        if (!CallBack("onStay", new object[] { this }))
            CallBack("OnStay", new object[] { this });
    }
    ...
    void OnBecameVisible()
    {
        ...
        if (onIntoView != null)
            onIntoView(this);
        if (!CallBack("onIntoView", new object[] { this }))
            CallBack("OnIntoView", new object[] { this });
    }
    ...
    void OnBecameInvisible()
    {
        ...
        if (onOutOfView != null)
            onOutOfView(this);
        if (!CallBack("onOutOfView", new object[] { this }))
            CallBack("OnOutOfView", new object[] { this });
    }
